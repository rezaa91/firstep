...
<div id="wrapper">
    ...
    <header id="header">
        ...
        <!--modal-->
        <button id="modal-btn" type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#modal">
            <i class="far fa-envelope-open"></i>
        </button><!--end of modal btn-->
        
        <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modal-label" aria-hidden="true">
            <div class="modal-dialog" role="form">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-white" id="modal-label">GET A QUOTE</h5>
                    ...
                    <div class="modal-body">
                        <form role="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" style="resize:none;" placeholder="Enter Message (Optional)"></textarea>
                            </div>
                        </form>
                    </div><!--end of modal body-->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-info">GET A QUOTE</button>
